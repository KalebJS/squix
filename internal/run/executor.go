...
func ExecuteSelect(sql, queryName string, params ExecutionParams) error {
	...
	for {
		model, err := table.Render(columns, columnTypes, data, elapsed, params.Connection, tableName, primaryKey, q, params.Config.DefaultColumnWidth, params.Config.UIVisibility, params.Config.KeybindMode, params.SaveCallback, statusMessage)
		if err != nil {
